  ...
  return (
    <DashboardLayout>
      <Row className="w-full m-4 flex justify-between" gutter={0}>
        <Col xs={24} md={11}>
          <span className="text-lg text-orang-100 p-2 text-center block">
            {" "}
            فرم ثبت نام{" "}
          </span>
          <span>
            <span className="text-lg text-orang-100 p-2"> ComponentName:</span>{" "}
            RegisterForm
          </span>
          <br />
          <span className="p-2  my-2 bg-gray-100 block my-8">
            {" "}
            registerHandler (props):Form submit functionHandler{" "}
          </span>
        ...
        <Col xs={24} md={11}>
          ...
          <span className="p-2  my-2 bg-gray-100 block my-8">
            {" "}
            loginHandler(props) :Form submit functionHandler{" "}
          </span>
        ...
        <Col xs={24} md={11}>
          ...
          <span className="p-2  my-2 bg-gray-100 block my-8">
            {" "}
            ContactForm(props) :Form submit functionHandler{" "}
          </span>
...
const RegisterForm = (props: registerFormType) => {
  ...
  return (
    <form
      className="w-full p-12 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]"
      onSubmit={handleSubmit((data: RegisterInputs) =>
    ...
    >
      <Row gutter={[12, 12]}>
        ...
        <Col xs={24}>
          ...
          />
          {errors.email && (
            <span className="text-red-600 text-sm p-2"> ایمیل اجباری است</span>
          )}
        </Col>
        <Col xs={24}>
          <input
          ...
          />
          {errors.password && (
            <span className="text-red-600 text-sm p-2"> پسورد اجباری است</span>
          )}
        </Col>
...
const LoginForm = (props: loginFormType) => {
  ...
  return (
    <form
      className="w-full p-12 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]"
      onSubmit={handleSubmit((data: LoginInputs) => props.loginHandler(data))}
    >
      <Row gutter={[12, 12]}>
        <Col xs={24}>
          <input
