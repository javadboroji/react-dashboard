    ...
    <div className={"container mx-auto my-32 justify-center items-center flex"}>
      <Col span={16}>
        <div className="flex justify-between">
          <p className="text-3xl px-4 font-light text-orang-100">
            {" "}
            وب<span className="text-blue-50"> سام</span>
          </p>
          <Button className="mx-4 px-8 border-0" onClick={changeFormMode}>
            {" "}
            ورود
          </Button>
        </div>
        <div className={"flex items-center shadow-lg rounded-2xl p-8"}>
          ...
          >
            <input
              ...
              className="border px-6 py-2 my-4 rounded-lg"
            />
            {errors.userName?.type === "required" && (
              <p role="alert" className="text-orang-100">
                {" "}
                نام اجباری می باشد{" "}
              </p>
            )}
